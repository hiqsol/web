...
class Controller extends \yii\base\Controller
{
    ...
    public function beforeAction($action)
    {
        if (parent::beforeAction($action)) {
            if ($this->enableCsrfValidation && $this->app->getErrorHandler()->exception === null && !$this->request->validateCsrfToken()) {
    ...
    {
        return $this->response->redirect(Url::to($url), $statusCode, $checkAjax);
    }
    ...
    {
        return $this->response->redirect($this->app->getHomeUrl());
    }
    ...
    {
        return $this->response->redirect($this->app->getUser()->getReturnUrl($defaultUrl));
    }
